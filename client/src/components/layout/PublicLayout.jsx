                ...
                <div className="sdp-footer-grid mb-12">
                    <div>
                        ...
                        <div className="flex gap-3">
                            {/* Assuming they don't have real links yet, omitting links per prompt or putting # */}
                            <a href="#" className="w-11 h-11 rounded-full bg-white/10 flex flex-col justify-center items-center hover:bg-brass hover:text-navy transition-colors"><Facebook size={20} /></a>
                            <a href="#" className="w-11 h-11 rounded-full bg-white/10 flex flex-col justify-center items-center hover:bg-brass hover:text-navy transition-colors"><Instagram size={20} /></a>
                            <a href="#" className="w-11 h-11 rounded-full bg-white/10 flex flex-col justify-center items-center hover:bg-brass hover:text-navy transition-colors"><Youtube size={20} /></a>
                        </div>
                    </div>
