...
const DOWNLOAD_CATEGORIES = [
    {
        ...
        files: [
            { name: "Common Admission Form 2026-27", desc: "For new enrollments in Junior College", size: "1.2 MB", format: "PDF", date: "May 10, 2026" },
            { name: "Scholarship Application Form", desc: "Merit and category-based scholarships", size: "850 KB", format: "PDF", date: "Apr 22, 2026" },
            { name: "Transfer Certificate (TC) Request Form", desc: "For migrating students", size: "450 KB", format: "PDF", date: "Jan 15, 2026" }
        ]
    },
    {
        ...
        files: [
            { name: "Academic Calendar 2026-27", desc: "Official schedule of events and exams", size: "2.4 MB", format: "PDF", date: "Jun 01, 2026" },
            { name: "Holiday List 2026", desc: "Public and institutional holidays", size: "550 KB", format: "PDF", date: "Jan 05, 2026" },
